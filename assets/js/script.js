...
function bordeRojo() {
  ...
  if (borde.style.border == "" ) {
    ...
    fondo.style.backgroundImage = 'url(/assets/imgs/fondo-caja.jpg)';
...
function verificacion() {
    ...
    if (sticker1 + sticker2 + sticker3 <= 10 && sticker1 + sticker2 + sticker3 >= 0 && sticker1 + sticker2 + sticker3 != 1) {
      mensaje.innerText = `Llevas ${sticker1 + sticker2 + sticker3} stickers`;
      mensaje.style.color = "black";
    } else if (sticker1 + sticker2 + sticker3 > 10){
        mensaje.innerText = `¡Llevas demasiados stickers (${sticker1+sticker2+sticker3})! Puedes llevar un máximo de 10 unidades`;
        mensaje.style.color = "red"
    } else if (sticker1 + sticker2 + sticker3 == 1) {
      mensaje.innerText = `Llevas ${sticker1 + sticker2 + sticker3} sticker`;
      mensaje.style.color = "black";
    } else {
        mensaje.innerText = "No puedes seleccionar números negativos. ¡Inténtalo otra vez!";
        mensaje.style.color = "red";
    }
}
